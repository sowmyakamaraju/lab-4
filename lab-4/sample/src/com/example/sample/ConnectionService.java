...
*/
   ...
   private void updateAccelerometerCals(BluetoothGattCharacteristic characteristic) {
	   ...
	   String gyroscopeData = SensorTagData.extractGyroscopeReading(characteristic,0);
       
       Log.i("gyroscope", gyroscopeData);

       
       double HumidData;
       HumidData = SensorTagData.extractHumidity(characteristic);
	   String humidity = String.valueOf(HumidData);
	   Log.i("humidity", humidity);
	   
	   String output =  string + "\t" + gyroscopeData + "\t" + humidity;
